...
<div class="card">
  ...
  <div class="card-body">
      ...
      <form action="{{ url('courses/' .$courses->id) }}" method="post">
        ...
        <input type="text" name="address" id="address" value="{{$courses->address}}" class="form-control"></br>
        <label>Mobile</label></br>
        <input type="text" name="mobile" id="mobile" value="{{$courses->mobile}}" class="form-control"></br>
